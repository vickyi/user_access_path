...
-- 2017-09-15
alter table fct_path_list_off_5levels add columns (openid string comment '微信openid') cascade;

alter table fct_path_list_off_5levels add columns (entrance_scene_value int comment '场景值') cascade;
alter table fct_path_list_off_5levels add columns (entrance2_scene_value int comment '场景值') cascade;
alter table fct_path_list_off_5levels add columns (guide_scene_value int comment '场景值') cascade;
alter table fct_path_list_off_5levels add columns (gudie2_scene_value int comment '场景值') cascade;
alter table fct_path_list_off_5levels add columns (before_goods_scene_value int comment '场景值') cascade;
